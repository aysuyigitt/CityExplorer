...
namespace CityExplorer.DataAccessLayer.Migrations
{
    ...
    [Migration("20250303174804_mig_add_ticket")]
    partial class mig_add_ticket
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CityExplorer.EntitiesLayer.Entities.Blog", b =>
                {
            ...
            modelBuilder.Entity("CityExplorer.EntitiesLayer.Entities.BlogDetail", b =>
                {
            ...
            modelBuilder.Entity("CityExplorer.EntitiesLayer.Entities.CategoryDetail", b =>
                {
                    b.Property<int>("CategoryDetailID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CategoryDetailID"));
            ...
            modelBuilder.Entity("CityExplorer.EntitiesLayer.Entities.EventDetail", b =>
                {
                    ...
                    b.Property<string>("Stil1")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Stil2")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Stil3")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CityExplorer.EntitiesLayer.Entities.Ticket", b =>
                {
            ...
            modelBuilder.Entity("CityExplorer.EntitiesLayer.Entities.BlogDetail", b =>
                {
                    b.HasOne("CityExplorer.EntitiesLayer.Entities.Blog", "Blog")
            ...
            modelBuilder.Entity("CityExplorer.EntitiesLayer.Entities.EventDetail", b =>
                {
                    b.HasOne("CityExplorer.EntitiesLayer.Entities.Event", "Event")
